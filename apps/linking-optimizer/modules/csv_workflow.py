...
from modules.semantic_tools import (
...
def render_csv_workflow():
    ...
    # from modules.help_ui import show_help_section
    ...
    if raw_df is None or raw_df.empty:
        ...
        if not text_columns:
            ...
            if isinstance(entities_summary, pd.DataFrame) and not entities_summary.empty:
                ...
                # Google KG feature disabled in standalone app
                ...
                # Google KG feature disabled in standalone app
                st.info("⚙️ Google Knowledge Graph integration está deshabilitada en la app standalone")
                if st.button(
